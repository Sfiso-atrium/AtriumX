...
stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-blue-600">          <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/>
        </svg>
      </div>
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="px-4 pt-4 pb-2">
            <h1 className="font-serif text-2xl text-slate-900">Discover</h1>
            <p className="text-slate-500 text-sm mt-1">Explore the existing marketplace and events.</p>
          </div>

          <div className="px-4 pt-2 pb-2 grid grid-cols-1 sm:grid-cols-[minmax(0,1.7fr)_minmax(220px,1fr)] gap-2">
            <div className="flex bg-[#FBFCFE] border border-[#EAF0F8] rounded-lg p-1">
              <button
                type="button"
                className="flex-1 bg-blue-600 border border-blue-600 text-white rounded-md py-2 text-sm font-bold"
              >
                Marketplace
              </button>
              <button
                ...
                className="flex-1 text-slate-500 hover:text-slate-900 hover:border-blue-400 rounded-md py-2 text-sm font-medium transition-colors"
              >
                Events
              </button>
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[#FBFCFE] rounded-lg pl-9 pr-9 py-2.5 text-slate-900 text-sm placeholder:text-slate-500 focus:outline-none focus:ring-1 focus:ring-blue-500/20 transition-colors"
              />
          ...
          <div className="px-4 pt-2 pb-1 flex flex-wrap items-center gap-2">
            <label className="flex items-center gap-2 bg-[#FBFCFE] rounded-lg px-3 py-2 text-sm font-medium text-slate-900 whitespace-nowrap">
              <span className="text-slate-500">For:</span>
              <select
                value={feedTab}
                onChange={e => setFeedTab(e.target.value as 'marketplace' | 'business')}
                className="bg-transparent text-slate-900 focus:outline-none cursor-pointer appearance-none"
              >
          ...
          <div className="px-4 pt-3">
            <div className="flex bg-[#FCFDFF] rounded-xl p-1">
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-lg text-xs font-bold transition-colors ${
                  marketMode === 'selling' ? 'bg-blue-600 text-white' : 'text-slate-500'
                }`}
              >
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-lg text-xs font-bold transition-colors ${
                  marketMode === 'wanted' ? 'bg-blue-600 text-white' : 'text-slate-500'
                }`}
              >
            ...
            <div className="px-4 pt-4">
              ...
              {lookingForLoading ? (
                ...
                <div className="text-center py-14">
                  <HandHelping size={30} className="text-slate-500 mx-auto mb-3 opacity-50" />
                  <p className="text-slate-900 font-bold text-sm mb-1">Nothing on the wanted board yet</p>
                ...
                <div className="flex flex-col gap-2.5">
                  {lookingFor.map(w => (
                    <div key={w.id} className="bg-[#FBFCFE] rounded-2xl p-4">
          ...
          {filtersOpen && (
            <div className="px-4 pb-3 flex flex-wrap items-center gap-2">
              <select
                ...
                className="bg-[#FBFCFE] rounded-xl px-3 py-2 text-slate-900 text-xs focus:outline-none focus:ring-1 focus:ring-blue-500/20"
              >
              ...
              <input
                ...
                placeholder="Min R"
                className="w-20 bg-[#FBFCFE] rounded-xl px-3 py-2 text-slate-900 text-xs placeholder:text-slate-500 focus:outline-none focus:ring-1 focus:ring-blue-500/20"
              />
              <input
                type="number"
                inputMode="numeric"
              ...
              <button
                ...
                className={`text-xs px-3 py-2 rounded-xl border transition-colors ${
                  negotiableOnly
                    ...
                    : 'bg-[#FCFDFF] text-slate-500 hover:bg-[#F7F9FC]'
                }`}
              >
                Open to offers
              </button>
